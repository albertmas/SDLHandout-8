...
bool ModuleSceneSpace::Start()
{
	...
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 700, 140);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 725, 140);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 740, 140);
	App->enemies->AddEnemy(ENEMY_TYPES::REDBIRD, 765, 140);

	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 1025, 70);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 1050, 70);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 1075, 70);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 1100, 70);
	App->enemies->AddEnemy(ENEMY_TYPES::BROWNCOOKIE, 1125, 70);

	App->enemies->AddEnemy(ENEMY_TYPES::MECH, 500, 70);
